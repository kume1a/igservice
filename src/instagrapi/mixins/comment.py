...
from src.instagrapi.exceptions import ClientError, ClientNotFoundError, MediaNotFound
from src.instagrapi.extractors import extract_comment
from src.instagrapi.types import Comment
