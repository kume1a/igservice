...
from src.instagrapi.exceptions import ClientError, TrackNotFound
from src.instagrapi.extractors import extract_track
from src.instagrapi.types import Track
