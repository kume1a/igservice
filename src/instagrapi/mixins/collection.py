...
from src.instagrapi.exceptions import CollectionNotFound
from src.instagrapi.extractors import extract_collection, extract_media_v1
from src.instagrapi.types import Collection, Media
